...
export default function RaceDetailPage() {
  ...
  async function handleSyncStartlist() {
    ...
    try {
      ...
      setMelding(
        "❌ Fout bij het ophalen van de startlijst. Probeer het later opnieuw.",
      );
    } finally {
      setSyncing(false);
    }
      ...
      <section className="banner card">
        ...
        <div style={{ marginTop: "1.5rem" }}>
          ...
          >
            {syncing
              ? "⏳ Bezig met ophalen..."
              : "🔄 Importeer Startlijst van PCS"}
          </button>
          <p style={{ fontSize: "0.8rem", marginTop: "0.5rem", opacity: 0.7 }}>
            Gebruik deze knop om alle renners in de database te laden zodra de
            startlijst op PCS bekend is.
          </p>
        </div>
      </section>
