...
export const getSpelersVoorCompetitie = (competitieId) => api.get(`/spelers/competitie/${competitieId}`);

export const getWedstrijden = () => api.get("/wedstrijden");
export const getKlassiekersByYear = (jaar) => api.get(`/wedstrijden/klassiekers/${jaar}`);
...
export const getScoreboardVoorSessie = (sessieId) => api.get(`/scores/sessie/${sessieId}`);
